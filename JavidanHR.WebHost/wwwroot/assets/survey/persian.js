...
/* harmony import */ var survey_creator_core__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(survey_creator_core__WEBPACK_IMPORTED_MODULE_0__);
            ...
            var persianStrings = {
                ...
                survey: {
                    edit: "ویرایش",
                    externalHelpLink: "نگاه کنید و ساختن فرم را آموزش ببینید",
                    externalHelpLinkUrl: "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion: "لطفا از جعبه ابزار سوالی در اینجا قرار دهید",
                    addLogicItem: "برای شخصی سازی فرم خود، قانونی را ایجاد کنید",
                    copy: "کپی",
                    duplicate: "کپی کردن",
                ...
                ed: {
                    ...
                    survey: "فرم",
                    settings: "تنظیمات فرم",
                    settingsTooltip: "باز کردن تنظیمات فرم",
                    surveySettings: "تنظیمات فرم",
                    surveySettingsTooltip: "تنظیمات فرم",
                    ...
                    testSurveyAgain: "آزمایش دوباره فرم",
                    testSurveyWidth: "عرض فرم: ",
                    navigateToMsg: "شما باید به موارد زیر بروید:",
                    saveSurvey: "ذخیره فرم",
                    saveSurveyTooltip: "ذخیره فرم",
                    saveTheme: "ذخیرۀ تم",
                    ...
                    propertyGridPlaceholderDescription: "برای کاوش در تنظیمات فرم، روی هر نماد دسته کلیک کنید. پس از افزودن یک عنصر فرم به سطح طراحی، تنظیمات اضافی در دسترس خواهند بود.",
                    correctJSON: "لطفا JSON را تصحیح کنید.",
                    surveyResults: "نتایج فرم: ",
                    ...
                    surveyPlaceHolder: "فرم خالی است. یک آیتم را از جعبه ابزار انتخاب یا روی دکمه ی زیر کلیک کنید",
                    ...
                    previewPlaceholderDescription: "این فرم حاوی هیچ عنصر قابل مشاهده ای نیست.",
                    previewPlaceholderDescriptionMobile: "این فرم حاوی هیچ عنصر قابل مشاهده ای نیست.",
                    ...
                    lg: {
                        ...
                        empty_tab: "یک آیتم را برای سفارشی کردن جریان فرم انتخاب کنید",
                        logicPlaceholderTitle: "بدون قوانین منطقی",
                        logicPlaceholderTitleMobile: "بدون قوانین منطقی",
                        logicPlaceholderDescription: "یک قانون برای سفارشی کردن جریان فرم ایجاد کنید.",
                        logicPlaceholderDescriptionMobile: "یک قانون برای سفارشی کردن جریان فرم ایجاد کنید.",
                        ...
                        trigger_completeName: "تکمیل فرم",
                        ...
                        trigger_skipDescription: "زمانی که عبارت منطقی صحیح برمی گرداند، سپس فرم به سوال انتخابی می رود.",
                        ...
                        trigger_completeText: "بررسی فرم تمام شد",
                        ...
                        trigger_skipText: "رد کردن فرم برای سوال {0}", //{0} question name
                ...
                pe: {
                    ...
                    survey: {
                        ...
                        readOnly: "فرم را فقط خواندنی کنید"
                    },
                    page: {
                        name: "نام صفحه",
                        title: "عنوان",
                    ...
                    masksettings: {
                        saveMaskedValue: "ذخیره مقدار ماسک در نتایج فرم"
                    },
                    patternmask: {
                        pattern: "الگوی ارزش"
                    },
                    ...
                    showPreviewBeforeComplete: "پیش نمایش پاسخ قبل از ارسال فرم",
                    ...
                    surveyTitlePlaceholder: "عنوان فرم را اینجا وارد کنید",
                    ...
                    surveyDescriptionPlaceholder: "توضیحات فرم را وارد کنید",
                    ...
                    includeIntoResult: "شامل نتایج فرم",
                    ...
                    cookieName: "نام کوکی (به منظور جلوگیری از اجرای دوباره فرم)",
                    partialSendEnabled: "ارسال نتایج فرم در صفحه بعدی",
                    ...
                    completeText: "متن دکمه تکمیل فرم",
                    previewText: "پیش نمایش متن دکمه",
                    editText: "ویرایش متن دکمه",
                    startSurveyText: "متن دکمه شروع فرم",
                    ...
                    firstPageIsStartPage: "صفحه اول در فرم نقطه آغازین آن است.",
                    showCompletePage: "نمایش صفحه اتمام فرم در پایان (completedHtml)",
                    ...
                    timeLimit: "نهایت زمان برای اتمام فرم",
                    timeLimitPerPage: "نهایت زمان برای اتمام این صفحه فرم",
                    ...
                    questionsOnPageMode: "ساختار فرم",
                    ...
                    theme: {
                        ...
                        panelBackgroundTransparency: "تاری پس زمینه پانل",
                        questionBackgroundTransparency: "تاری پس زمینه ی سؤال",
                        fontSize: "اندازه قلم",
                        scale: "مقیاس",
                        ...
                        "--sjs-general-backcolor-dim": "رنگ پس زمینه",
                        "--sjs-primary-backcolor": "پس زمینه ی اصلی",
                        "--sjs-primary-forecolor": "پیش زمینه اصلی",
                    ...
                    "header@header": {
                        ...
                        surveyTitle: "قلم عنوان فرم",
                        surveyDescription: "قلم توصیف فرم",
                        headerTitle: "قلم عنوان فرم",
                        headerDescription: "قلم توصیف فرم",
                        inheritWidthFrom: "عرض منطقه محتوا",
                        textAreaWidth: "عرض متن",
                        backgroundColorSwitch: "رنگ پس زمینه",
                ...
                ew: {
                    ...
                    showOnPage: "نمایش فرم در یک صفحه",
                    showInWindow: "نمایش فرم در یک پنجره",
                ...
                pehelp: {
                    panel: {
                        ...
                        requiredIf: "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع از ارسال فرم می شود مگر اینکه حداقل یک سوال تو در تو پاسخ داشته باشد.",
                        questionTitleLocation: "برای تمام سوالات در این پنل اعمال می شود. اگر می خواهید این تنظیم را لغو کنید، قوانین تراز عنوان را برای سوالات فردی تعریف کنید. گزینه \"Inherit\" به طور پیش فرض تنظیم سطح صفحه (در صورت تنظیم) یا سطح فرم (\"بالا\" را اعمال می کند).",
                        ...
                        questionErrorLocation: "مکان یک پیام خطا را در رابطه با تمام سوالات درون پانل تنظیم می کند. گزینه \"Inherit\" شامل تنظیمات سطح صفحه (در صورت تنظیم) یا سطح فرم است.",
                        questionOrder: "ترتیب اصلی سوالات را نگه می دارد یا انها را تصادفی می کند. گزینه \"Inherit\" شامل تنظیمات سطح صفحه (در صورت تنظیم) یا سطح فرم است.",
                    ...
                    paneldynamic: {
                        ...
                        enableIf: "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که حالت فقط خواندنی را برای پانل غیرفعال می کند.",
                        requiredIf: "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع از ارسال فرم می شود مگر اینکه حداقل یک سوال تو در تو پاسخ داشته باشد.",
                        templateQuestionTitleLocation: "برای تمام سوالات در این پنل اعمال می شود. اگر می خواهید این تنظیم را لغو کنید، قوانین تراز عنوان را برای سوالات فردی تعریف کنید. گزینه \"Inherit\" به طور پیش فرض تنظیم سطح صفحه (در صورت تنظیم) یا سطح فرم (\"بالا\" را اعمال می کند).",
                        ...
                        templateErrorLocation: "محل یک پیام خطا را در رابطه با سؤال با ورودی نامعتبر تنظیم میکند. انتخاب بین: \"بالا\" - یک متن خطا در بالای جعبه سوال قرار می گیرد؛ \"پایین\" - یک متن خطا در پایین جعبه سوال قرار می گیرد. گزینه \"Inherit\" به طور پیش فرض تنظیم سطح صفحه (در صورت تنظیم) یا سطح فرم (\"بالا\" را اعمال می کند).",
                        errorLocation: "مکان یک پیام خطا را در رابطه با تمام سوالات درون پانل تنظیم می کند. گزینه \"Inherit\" شامل تنظیمات سطح صفحه (در صورت تنظیم) یا سطح فرم است.",
                        page: "پانل را به انتهای صفحه انتخاب شده تغییر می دهد.",
                        innerIndent: "اضافه کردن فضا یا حاشیه بین محتوای پانل و مرز سمت چپ جعبه پانل.",
                        startWithNewLine: "عدم انتخاب برای نمایش پانل در یک خط با سوال قبلی یا پانل. تنظیمات اعمال نمی شود اگر پانل اولین عنصر در فرم شما باشد.",
                        state: "را انتخاب کنید از: \"گسترش یافته\" - پانل به طور کامل نمایش داده می شود و می تواند سقوط کند؛ \"سقوط\" - پانل تنها عنوان و توضیحات را نمایش می دهد و می تواند گسترش یابد. \"Locked\" - پانل به طور کامل نمایش داده می شود و نمی تواند سقوط کند.",
                        ...
                        titleLocation: "این تنظیم به طور خودکار توسط تمام سوالات موجود در این پنل به ارث برده می شود. اگر می خواهید این تنظیم را لغو کنید، قوانین تراز عنوان را برای سوالات فردی تعریف کنید. گزینه \"Inherit\" به طور پیش فرض تنظیم سطح صفحه (در صورت تنظیم) یا سطح فرم (\"بالا\" را اعمال می کند).",
                        descriptionLocation: "گزینه \"Inherit\" سطح صفحه (در صورت تنظیم) یا تنظیم سطح فرم (\"زیر عنوان پانل\" به طور پیش فرض) اعمال می شود.",
                    ...
                    question: {
                        ...
                        requiredIf: "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع پیشرفت یا تسلیم فرم می شود مگر اینکه سوال پاسخی دریافت کند.",
                        ...
                        titleLocation: "قوانین هم ترازی عنوان تعریف شده در یک پانل، صفحه یا سطح فرم را لغو می کند. گزینه \"Inherit\" تنظیمات سطح بالاتر (در صورت تنظیم) یا تنظیمات سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند.",
                        descriptionLocation: "گزینه \"به ارث بردن\" تنظیم سطح فرم (\"تحت عنوان سوال\" به طور پیش فرض) اعمال می شود.",
                        errorLocation: "مکان یک پیام خطا را در رابطه با سؤال با ورودی نامعتبر تنظیم می کند. انتخاب بین: \"بالا\" - یک متن خطا در بالای جعبه سوال قرار می گیرد؛ \"پایین\" - یک متن خطا در پایین جعبه سوال قرار می گیرد. گزینه \"ارث\" تنظیم سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند.",
                        indent: "فضای یا حاشیه بین محتوای سوال و مرز سمت چپ جعبه سوال اضافه می کند.",
                        width: "عرض سوال را متناسب با سایر عناصر فرم در همان خط تنظیم می کند. مقادیر CSS را می پذیرد (px، ٪، in، pt و غیره).",
                        surveyvalidator: {
                            expression: "از نماد چوب جادویی برای تنظیم یک قانون اعتبار سنجی برای سوال استفاده کنید."
                        },
                        textUpdateMode: "انتخاب از: \"در تمرکز از دست رفته\" - مقدار به روز شده است زمانی که فیلد ورودی تمرکز خود را از دست می دهد؛ \"در هنگام تایپ\" - مقدار در زمان واقعی به روز می شود، زیرا کاربران تایپ می کنند. گزینه \"ارث\" تنظیم سطح فرم (\"در تمرکز از دست رفته\" به طور پیش فرض) اعمال می شود.",
                    ...
                    file: {
                        imageHeight: "ارتفاع تصویر را در نتایج فرم تنظیم می کند.",
                        imageWidth: "عرض تصویر را در نتایج فرم تنظیم می کند.",
                    ...
                    // survey templates
                    survey: {
                        readOnly: "اگر می خواهید از پر کردن فرم پاسخ دهندگان جلوگیری کنید، انتخاب کنید.",
                        progressBarLocation: "مکان نوار پیشرفت را تنظیم می کند. مقدار \"خودکار\" نوار پیشرفت را در بالا یا پایین سربرگ فرم نشان می دهد."
                    },
                    matrixdropdowncolumn: {
                    ...
                    widthMode: "را انتخاب کنید از: \"استاتیک\" - مجموعه عرض ثابت؛ \"پاسخگو\" - باعث می شود فرم عرض کامل صفحه نمایش را اشغال کند؛ \"Auto\" - هر یک از این دو را بسته به نوع سوال مورد استفاده اعمال می کند.",
                    cookieName: "کوکی ها کاربران را از پر کردن همان فرم دو بار جلوگیری می کند.",
                    ...
                    autoAdvanceEnabled: "انتخاب کنید که آیا می خواهید فرم به طور خودکار به صفحه بعدی پیش برود پس از اینکه پاسخ دهنده به همه سؤالات موجود در صفحه فعلی پاسخ داد. اگر آخرین سؤال در صفحه باز باشد یا اجازه پاسخ های متعدد را بدهد، این ویژگی اعمال نمی شود.",
                    autoAdvanceAllowComplete: "انتخاب کنید که ایا می خواهید فرم به طور خودکار پس از پاسخ دادن به تمام سوالات پاسخ دهد.",
                    ...
                    questionTitleLocation: "به تمام سوالات در فرم اعمال می شود. این تنظیم را می توان با قوانین هم ترازی عنوان در سطوح پایین تر لغو کرد: پانل، صفحه یا سوال. یک تنظیم سطح پایین تر، کسانی را که در سطح بالاتری قرار دارند، نادیده می گیرد.",
                    ...
                    includeIntoResult: "اگر میخواهید مقدار محاسبهشده عبارت همراه با نتایج فرم ذخیره شود ، برگزینید.",
                    ...
                    keyName: "اگر ستون مشخص شده حاوی مقادیر یکسان باشد، فرم خطای \"مقدار کلیدی غیر منحصر به فرد\" را پرتاب می کند.",
                    description: "یک زیرنویس تایپ کنید.",
                    locale: "یک زبان را برای شروع ایجاد فرم خود انتخاب کنید. برای اضافه کردن ترجمه، به یک زبان جدید بروید و متن اصلی را در اینجا یا در زبانه ترجمه ترجمه ترجمه کنید.",
                    ...
                    timeLimit: "یک فاصله زمانی در ثانیه که پس از ان فرم به طور خودکار به صفحه تشکر از شما پیش می رود.",
                    timeLimitPerPage: "یک فاصله زمانی در ثانیه که پس از ان فرم به طور خودکار به صفحه بعدی پیش می رود.",
                    ...
                    page: {
                        ...
                        navigationTitle: "عنوانی که روی دکمه پیمایش در نوار پیشرفت یا فهرست مطالب (TOC) نمایش داده می شود. اگر این فیلد را خالی بگذارید، دکمه پیمایش از عنوان صفحه یا نام صفحه استفاده می کند. برای فعال کردن نوار پیشرفت یا TOC، به \"فرم\" → \"ناوبری\" بروید.",
                        timeLimit: "یک فاصله زمانی در ثانیه که پس از ان فرم به طور خودکار به صفحه بعدی پیش می رود.",
                        ...
                        requiredIf: "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع از ارسال فرم می شود مگر اینکه حداقل یک سوال تو در تو پاسخ داشته باشد.",
                        questionTitleLocation: "به تمام سوالات موجود در این صفحه اعمال می شود. اگر می خواهید این تنظیمات را لغو کنید، قوانین تراز عنوان را برای سوالات یا پانل های فردی تعریف کنید. گزینه \"ارث\" تنظیم سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند.",
                        questionTitleWidth: "عرض ثابت را برای عناوین سؤال تنظیم می کند وقتی که انها در سمت چپ جعبه های سوال خود قرار دارند. مقادیر CSS را می پذیرد (px، ٪، in، pt و غیره).",
                        questionErrorLocation: "مکان یک پیام خطا را در رابطه با سؤال با ورودی نامعتبر تنظیم می کند. انتخاب بین: \"بالا\" - یک متن خطا در بالای جعبه سوال قرار می گیرد؛ \"پایین\" - یک متن خطا در پایین جعبه سوال قرار می گیرد. گزینه \"ارث\" تنظیم سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند.",
                        questionOrder: "ترتیب اصلی سوالات را نگه می دارد یا انها را تصادفی می کند. گزینه \"ارث\" تنظیم سطح فرم (\"اصلی\" به طور پیش فرض) را اعمال می کند. اثر این تنظیم فقط در تب Preview قابل مشاهده است.",
                        showNavigationButtons: "قابلیت مشاهده دکمههای پیمایش را روی صفحه تنظیم میکند. گزینه \"به ارث بردن\" تنظیم سطح فرم را اعمال می کند که به طور پیش فرض به \"قابل مشاهده\" است.",
                    ...
                    waitForUpload: "اطمینان حاصل می کند که کاربران تا زمانی که فایل ها اپلود نشده اند، فرم را تکمیل نخواهند کرد.",
                    ...
                    defaultDisplayValue: "مقداری که در سؤالات HTML و در عناوین پویا و توضیحات عناصر فرم زمانی که مقدار سوال خالی است، نمایش داده می شود.",
                    ...
                    clearIfInvisible: "انتخاب کنید که ایا برای پاک کردن یا نه ارزش سوال پنهان شده توسط منطق شرطی و زمانی که به ان را انجام دهد. گزینه \"ارث\" تنظیم سطح فرم (\"پس از اتمام فرم\" به طور پیش فرض) اعمال می شود.",
                    ...
                    valueTrue: "ارزش برای صرفه جویی در نتایج فرم زمانی که پاسخ دهندگان پاسخ مثبت می دهند.",
                    valueFalse: "ارزش برای صرفه جویی در نتایج فرم زمانی که پاسخ دهندگان پاسخ منفی می دهند.",
                    ...
                    storeOthersAsComment: "انتخاب کنید برای ذخیره \"دیگر\" مقدار گزینه به عنوان یک ملک جداگانه در نتایج فرم.",
                    ...
                    masksettings: {
                        saveMaskedValue: "انتخاب کنید که ایا می خواهید مقدار سؤال را با یک ماسک کاربردی در نتایج فرم ذخیره کنید."
                    },
                    patternmask: {
                    ...
                    theme: {
                        ...
                        primaryColor: "یک رنگ تکمیلی تنظیم می کند که عناصر کلیدی فرم را برجسته می کند.",
                        panelBackgroundTransparency: "شفافیت پانل ها و جعبه های سوال را نسبت به پیشینه فرم تنظیم می کند.",
                        questionBackgroundTransparency: "شفافیت عناصر ورودی را نسبت به پیشینه فرم تنظیم می کند.",
                        ...
                        "--sjs-general-backcolor-dim": "رنگ پس زمینه اصلی فرم را تنظیم می کند."
                    },
                    header: {
                        inheritWidthFrom: "گزینه \"همان کانتینر\" به طور خودکار عرض ناحیه محتوای هدر را تنظیم می کند تا در عنصر HTML که فرم در آن قرار می گیرد قرار گیرد.",
                        textAreaWidth: "عرض ناحیه سرصفحه که حاوی عنوان و توضیحات فرم است که بر حسب پیکسل اندازه گیری می شود.",
                        overlapEnabled: "هنگامی که فعال باشد، بالای فرم پایین هدر را همپوشانی می کند.",
                        mobileHeight: "هنگامی که روی 0 تنظیم می شود، ارتفاع به طور خودکار محاسبه می شود تا محتوای هدر را در خود جای دهد."
                    },
                    progressBarInheritWidthFrom: "گزینه \"همان کانتینر\" به طور خودکار عرض ناحیه نوار پیشرفت را تنظیم می کند تا در عنصر HTML که فرم در آن قرار می گیرد قرار گیرد.",
                    singleInputTitleTemplate: "زمانی استفاده می شود که \"طرح فرم\" روی \"فیلد ورودی واحد در هر صفحه\" تنظیم شده باشد. در این چیدمان، ماتریس تقسیم می شود تا هر فیلد ورودی در یک صفحه جداگانه ظاهر شود. از مکان نگهدارنده {rowIndex} برای درج شماره گذاری خودکار، {rowTitle} یا {rowName} برای ارجاع به عنوان یا شناسه ردیف و {row.columnid} برای درج مقدار یک ستون ماتریس خاص استفاده کنید."
                },
                // Properties
                p: {
                    title: {
                    ...
                    surveyId: "شناسه فرم",
                    surveyPostId: "شناسه فرم",
                    surveyShowDataSaving: "فرم نشان می دهد صرفه جویی در داده ها",
                    ...
                    backgroundImage: "تصویر زمینه",
                    backgroundImageFit: "مناسبسازی تصویر پس زمینه",
                    backgroundImageAttachment: "پیوست تصویر پس زمینه",
                    backgroundOpacity: "تاری پس زمینه",
                ...
                theme: {
                    ...
                    backgroundDimColor: "رنگ پس زمینه",
                    cornerRadius: "شعاع گوشه",
                    backcolor: "پس زمینه ی پیشفرض",
                    hovercolor: "پس زمینه شناور",
            ...
            // ed.surveySettings: "Survey Settings" => "تنظیمات فرم"
            // ed.surveySettingsTooltip: "Open survey settings" => "باز کردن تنظیمات فرم"
            ...
            // pe.showPreviewBeforeComplete: "Preview answers before submitting the survey" => "پیش نمایش پاسخ قبل از ارسال فرم"
            ...
            // pe.includeIntoResult: "Include into survey results" => "شامل نتایج فرم"
            ...
            // pe.questionsOnPageMode: "Survey structure" => "ساختار فرم"
            ...
            // pehelp.cookieName: "Cookies prevent users from filling out the same survey twice." => "کوکی ها کاربران را از پر کردن همان فرم دو بار جلوگیری می کند."
            ...
            // pehelp.keyName: "If the specified column contains identical values, the survey throws the \"Non-unique key value\" error." => "اگر ستون مشخص شده حاوی مقادیر یکسان باشد، فرم خطای \"مقدار کلیدی غیر منحصر به فرد\" را پرتاب می کند."
            ...
            // p.surveyId: "Survey id" => "شناسه فرم"
            // p.surveyPostId: "Survey post id" => "شناسه فرم"
            // p.surveyShowDataSaving: "Survey show data saving" => "فرم نشان می دهد صرفه جویی در داده ها"
            ...
            // p.backgroundColor: "Background color" => "رنگ پس زمینه"
            ...
            // p.backgroundImageFit: "Background image fit" => "مناسبسازی تصویر پس زمینه"
            // p.backgroundImageAttachment: "Background image attachment" => "پیوست تصویر پس زمینه"
            // p.backgroundOpacity: "Background opacity" => "تاری پس زمینه"
            ...
            // theme.--background: "Background color" => "رنگ پس زمینه"
            // theme.--background-dim-light: "Background dim light color" => "پس زمینه رنگ نور کم"
            // theme.--primary-foreground: "Primary foreground color" => "رنگ پیش زمینه اصلی"
            // theme.--foreground: "Foreground color" => "رنگ پیش زمینه"
            ...
            // theme.panelBackgroundTransparency: "Panel background opacity" => "تاری پس زمینه پانل"
            // theme.questionBackgroundTransparency: "Question background opacity" => "تاری پس زمینه ی سؤال"
            ...
            // theme.backcolor: "Default background" => "پس زمینه ی پیشفرض"
            // theme.hovercolor: "Hover background" => "پس زمینه شناور"
            // theme.borderDecoration: "Border decoration" => "دکوراسیون مرزی"
            // theme.accentBackground: "Accent background" => "پس زمینه ی اصلی"
            // theme.accentForeground: "Accent foreground" => "پیش زمینه اصلی"
            ...
            // theme.surveyTitleFont: "Survey title font" => "قلم عنوان فرم"
            ...
            // theme.headerInheritWidthFromSurvey: "Same as survey" => "همانند فرم"
            // theme.headerInheritWidthFromPage: "Fit to page" => "متناسب با صفحه"
            // theme.headerTextAreaWidth: "Text width" => "عرض متن"
            // theme.headerBackgroundColorSwitch: "Background color" => "رنگ پس زمینه"
            // theme.headerBackgroundColorNone: "None" => "هیچ کدام"
            // theme.headerBackgroundColorAccentColor: "Accent color" => "رنگ اصلی"
            ...
            // theme.surveyDescriptionFont: "Survey description font" => "قلم توصیف فرم"
            ...
            // survey.description: "Survey description" => "توضیحات فرم"
            ...
            // showQuestionNumbers.onPanel: "Reset on each panel" => "بازنشانی در هر پنل"
            // showQuestionNumbers.onSurvey: "Continue across the survey" => "ادامه در سراسر فرم"
            ...
            // panel.requiredIf: "Use the magic wand icon to set a conditional rule that prevents survey submission unless at least one nested question has an answer." => "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع از ارسال فرم می شود مگر اینکه حداقل یک سوال تو در تو پاسخ داشته باشد."
            // panel.questionTitleLocation: "Applies to all questions within this panel. If you want to override this setting, define title alignment rules for individual questions. The \"Inherit\" option applies the page-level (if set) or survey-level setting (\"Top\" by default)." => "برای تمام سوالات در این پنل اعمال می شود. اگر می خواهید این تنظیم را لغو کنید، قوانین تراز عنوان را برای سوالات فردی تعریف کنید. گزینه \"Inherit\" به طور پیش فرض تنظیم سطح صفحه (در صورت تنظیم) یا سطح فرم (\"بالا\" را اعمال می کند)."
            // panel.questionErrorLocation: "Sets the location of an error message in relation to all questions within the panel. The \"Inherit\" option applies the page-level (if set) or survey-level setting." => "مکان یک پیام خطا را در رابطه با تمام سوالات درون پانل تنظیم می کند. گزینه \"Inherit\" شامل تنظیمات سطح صفحه (در صورت تنظیم) یا سطح فرم است."
            // panel.questionOrder: "Keeps the original order of questions or randomizes them. The \"Inherit\" option applies the page-level (if set) or survey-level setting." => "ترتیب اصلی سوالات را نگه می دارد یا انها را تصادفی می کند. گزینه \"Inherit\" شامل تنظیمات سطح صفحه (در صورت تنظیم) یا سطح فرم است."
            ...
            // paneldynamic.requiredIf: "Use the magic wand icon to set a conditional rule that prevents survey submission unless at least one nested question has an answer." => "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع از ارسال فرم می شود مگر اینکه حداقل یک سوال تو در تو پاسخ داشته باشد."
            // paneldynamic.templateQuestionTitleLocation: "Applies to all questions within this panel. If you want to override this setting, define title alignment rules for individual questions. The \"Inherit\" option applies the page-level (if set) or survey-level setting (\"Top\" by default)." => "برای تمام سوالات در این پنل اعمال می شود. اگر می خواهید این تنظیم را لغو کنید، قوانین تراز عنوان را برای سوالات فردی تعریف کنید. گزینه \"Inherit\" به طور پیش فرض تنظیم سطح صفحه (در صورت تنظیم) یا سطح فرم (\"بالا\" را اعمال می کند)."
            // paneldynamic.templateErrorLocation: "Sets the location of an error message in relation to a question with invalid input. Choose between: \"Top\" - an error text is placed at the top of the question box; \"Bottom\" - an error text is placed at the bottom of the question box. The \"Inherit\" option applies the page-level (if set) or survey-level setting (\"Top\" by default)." => "محل یک پیام خطا را در رابطه با سؤال با ورودی نامعتبر تنظیم میکند. انتخاب بین: \"بالا\" - یک متن خطا در بالای جعبه سوال قرار می گیرد؛ \"پایین\" - یک متن خطا در پایین جعبه سوال قرار می گیرد. گزینه \"Inherit\" به طور پیش فرض تنظیم سطح صفحه (در صورت تنظیم) یا سطح فرم (\"بالا\" را اعمال می کند)."
            ...
            // paneldynamic.descriptionLocation: "The \"Inherit\" option applies the page-level (if set) or survey-level setting (\"Under the panel title\" by default)." => "گزینه \"Inherit\" سطح صفحه (در صورت تنظیم) یا تنظیم سطح فرم (\"زیر عنوان پانل\" به طور پیش فرض) اعمال می شود."
            ...
            // question.requiredIf: "Use the magic wand icon to set a conditional rule that prevents survey advancing or submission unless the question received an answer." => "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع پیشرفت یا تسلیم فرم می شود مگر اینکه سوال پاسخی دریافت کند."
            ...
            // question.titleLocation: "Overrides title alignment rules defined on a panel, page or survey level. The \"Inherit\" option applies any higher-level settings (if set) or survey-level setting (\"Top\" by default)." => "قوانین هم ترازی عنوان تعریف شده در یک پانل، صفحه یا سطح فرم را لغو می کند. گزینه \"Inherit\" تنظیمات سطح بالاتر (در صورت تنظیم) یا تنظیمات سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند."
            // question.descriptionLocation: "The \"Inherit\" option applies the survey-level setting (\"Under the question title\" by default)." => "گزینه \"به ارث بردن\" تنظیم سطح فرم (\"تحت عنوان سوال\" به طور پیش فرض) اعمال می شود."
            // question.errorLocation: "Sets the location of an error message in relation to the question with invalid input. Choose between: \"Top\" - an error text is placed at the top of the question box; \"Bottom\" - an error text is placed at the bottom of the question box. The \"Inherit\" option applies the survey-level setting (\"Top\" by default)." => "مکان یک پیام خطا را در رابطه با سؤال با ورودی نامعتبر تنظیم می کند. انتخاب بین: \"بالا\" - یک متن خطا در بالای جعبه سوال قرار می گیرد؛ \"پایین\" - یک متن خطا در پایین جعبه سوال قرار می گیرد. گزینه \"ارث\" تنظیم سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند."
            ...
            // question.width: "Sets the width of the question in proportion to other survey elements in the same line. Accepts CSS values (px, %, in, pt, etc.)." => "عرض سوال را متناسب با سایر عناصر فرم در همان خط تنظیم می کند. مقادیر CSS را می پذیرد (px، ٪، in، pt و غیره)."
            ...
            // file.imageHeight: "Adjusts the height of the image in the survey results." => "ارتفاع تصویر را در نتایج فرم تنظیم می کند."
            // file.imageWidth: "Adjusts the width of the image in the survey results." => "عرض تصویر را در نتایج فرم تنظیم می کند."
            ...
            // survey.mode: "Choose between: \"Editable\" - enables respondents to fill out your survey; \"Read-only\" - disables form editing." => "انتخاب بین: \"قابل ویرایش\" - پاسخ دهندگان را قادر می سازد تا فرم خود را پر کنند. \"فقط خواندنی\" - ویرایش فرم را غیرفعال می کند."
            ...
            // matrixdropdowncolumn.requiredIf: "Use the magic wand icon to set a conditional rule that prevents survey submission unless at least one nested question has an answer." => "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع از ارسال فرم می شود مگر اینکه حداقل یک سوال تو در تو پاسخ داشته باشد."
            ...
            // pehelp.: "Select if you want the survey to advance to the next page automatically after a respondent answers all questions on the current page." => "انتخاب کنید که ایا می خواهید فرم به طور خودکار به صفحه بعدی پیش رود پس از اینکه یک پاسخ دهنده به تمام سوالات در صفحه فعلی پاسخ داد."
            ...
            // pehelp.showProgressBar: "Sets the visibility and location of a progress bar. The \"Auto\" value displays the progress bar above or below the survey header." => "دید و مکان یک نوار پیشرفت را تنظیم می کند. مقدار \"Auto\" نوار پیشرفت را در بالا یا پایین هدر فرم نشان می دهد."
            ...
            // pehelp.questionTitleLocation: "Applies to all questions within the survey. This setting can be overridden by title alignment rules at lower levels: panel, page, or question. A lower-level setting will override those on a higher level." => "به تمام سوالات در فرم اعمال می شود. این تنظیم را می توان با قوانین هم ترازی عنوان در سطوح پایین تر لغو کرد: پانل، صفحه یا سوال. یک تنظیم سطح پایین تر، کسانی را که در سطح بالاتری قرار دارند، نادیده می گیرد."
            ...
            // pehelp.includeIntoResult: "Select if you wish the calculated value of the expression to be saved along with survey results." => "اگر میخواهید مقدار محاسبهشده عبارت همراه با نتایج فرم ذخیره شود ، برگزینید."
            ...
            // pehelp.locale: "Choose a language to begin creating your survey. To add a translation, switch to a new language and translate the original text here or in the Translations tab." => "یک زبان را برای شروع ایجاد فرم خود انتخاب کنید. برای اضافه کردن ترجمه، به یک زبان جدید بروید و متن اصلی را در اینجا یا در زبانه ترجمه ترجمه ترجمه کنید."
            ...
            // pehelp.timeLimit: "A time interval in seconds after which the survey auto-advances to the Thank You page." => "یک فاصله زمانی در ثانیه که پس از ان فرم به طور خودکار به صفحه تشکر از شما پیش می رود."
            // pehelp.timeLimitPerPage: "A time interval in seconds after which the survey auto-advances to the next page." => "یک فاصله زمانی در ثانیه که پس از ان فرم به طور خودکار به صفحه بعدی پیش می رود."
            // page.timeLimit: "A time interval in seconds after which the survey auto-advances to the next page." => "یک فاصله زمانی در ثانیه که پس از ان فرم به طور خودکار به صفحه بعدی پیش می رود."
            ...
            // page.requiredIf: "Use the magic wand icon to set a conditional rule that prevents survey submission unless at least one nested question has an answer." => "از نماد چوب جادویی برای تنظیم یک قانون شرطی استفاده کنید که مانع از ارسال فرم می شود مگر اینکه حداقل یک سوال تو در تو پاسخ داشته باشد."
            // page.questionTitleLocation: "Applies to all questions within this page. If you want to override this setting, define title alignment rules for individual questions or panels. The \"Inherit\" option applies the survey-level setting (\"Top\" by default)." => "به تمام سوالات موجود در این صفحه اعمال می شود. اگر می خواهید این تنظیمات را لغو کنید، قوانین تراز عنوان را برای سوالات یا پانل های فردی تعریف کنید. گزینه \"ارث\" تنظیم سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند."
            // page.questionErrorLocation: "Sets the location of an error message in relation to the question with invalid input. Choose between: \"Top\" - an error text is placed at the top of the question box; \"Bottom\" - an error text is placed at the bottom of the question box. The \"Inherit\" option applies the survey-level setting (\"Top\" by default)." => "مکان یک پیام خطا را در رابطه با سؤال با ورودی نامعتبر تنظیم می کند. انتخاب بین: \"بالا\" - یک متن خطا در بالای جعبه سوال قرار می گیرد؛ \"پایین\" - یک متن خطا در پایین جعبه سوال قرار می گیرد. گزینه \"ارث\" تنظیم سطح فرم (\"بالا\" به طور پیش فرض) را اعمال می کند."
            // page.questionOrder: "Keeps the original order of questions or randomizes them. The \"Inherit\" option applies the survey-level setting (\"Original\" by default). The effect of this setting is only visible in the Preview tab." => "ترتیب اصلی سوالات را نگه می دارد یا انها را تصادفی می کند. گزینه \"ارث\" تنظیم سطح فرم (\"اصلی\" به طور پیش فرض) را اعمال می کند. اثر این تنظیم فقط در تب Preview قابل مشاهده است."
            // page.showNavigationButtons: "Sets the visibility of navigation buttons on the page. The \"Inherit\" option applies the survey-level setting, which defaults to \"Visible\"." => "قابلیت مشاهده دکمههای پیمایش را روی صفحه تنظیم میکند. گزینه \"به ارث بردن\" تنظیم سطح فرم را اعمال می کند که به طور پیش فرض به \"قابل مشاهده\" است."
            ...
            // pehelp.waitForUpload: "Ensures that users won't complete the survey until files are uploaded." => "اطمینان حاصل می کند که کاربران تا زمانی که فایل ها اپلود نشده اند، فرم را تکمیل نخواهند کرد."
            ...
            // pehelp.clearIfInvisible: "Choose whether or not to clear question values hidden by conditional logic and when to do it. The \"Inherit\" option applies the survey-level setting (\"Upon survey completion\" by default)." => "انتخاب کنید که ایا برای پاک کردن یا نه ارزش سوال پنهان شده توسط منطق شرطی و زمانی که به ان را انجام دهد. گزینه \"ارث\" تنظیم سطح فرم (\"پس از اتمام فرم\" به طور پیش فرض) اعمال می شود."
            ...
            // pehelp.valueTrue: "A value to save in survey results when respondents give a positive answer." => "ارزش برای صرفه جویی در نتایج فرم زمانی که پاسخ دهندگان پاسخ مثبت می دهند."
            // pehelp.valueFalse: "A value to save in survey results when respondents give a negative answer." => "ارزش برای صرفه جویی در نتایج فرم زمانی که پاسخ دهندگان پاسخ منفی می دهند."
            ...
            // pehelp.storeOthersAsComment: "Select to store the \"Other\" option value as a separate property in survey results." => "انتخاب کنید برای ذخیره \"دیگر\" مقدار گزینه به عنوان یک ملک جداگانه در نتایج فرم."
            ...
            // pehelp.autoAdvanceAllowComplete: "Select if you want the survey to complete automatically after a respondent answers all questions." => "انتخاب کنید که ایا می خواهید فرم به طور خودکار پس از پاسخ دادن به تمام سوالات پاسخ دهد."
            // masksettings.saveMaskedValue: "Save masked value in survey results" => "ذخیره مقدار ماسک در نتایج فرم"
            ...
            // masksettings.saveMaskedValue: "Select if you want to store the question value with an applied mask in survey results." => "انتخاب کنید که ایا می خواهید مقدار سؤال را با یک ماسک کاربردی در نتایج فرم ذخیره کنید."
            ...
            // theme.--sjs-general-backcolor-dim: "Background color" => "رنگ پس زمینه"
            // theme.--sjs-primary-backcolor: "Accent background" => "پس زمینه ی اصلی"
            // theme.--sjs-primary-forecolor: "Accent foreground" => "پیش زمینه اصلی"
            ...
            // header@header.surveyTitle: "Survey title font" => "قلم عنوان فرم"
            // header@header.surveyDescription: "Survey description font" => "قلم توصیف فرم"
            // header@header.headerTitle: "Survey title font" => "قلم عنوان فرم"
            // header@header.headerDescription: "Survey description font" => "قلم توصیف فرم"
            // header@header.inheritWidthFrom: "Content area width" => "عرض منطقه محتوا"
            // header@header.textAreaWidth: "Text width" => "عرض متن"
            // header@header.backgroundColorSwitch: "Background color" => "رنگ پس زمینه"
            ...
            // inheritWidthFrom.survey: "Same as survey" => "همانند فرم"
            // inheritWidthFrom.container: "Fit to container" => "مناسب برای ظرف"
            // backgroundColorSwitch.none: "None" => "هیچ کدام"
            // backgroundColorSwitch.accentColor: "Accent color" => "رنگ اصلی"
            ...
            // theme.backgroundColor: "Background color" => "رنگ پس زمینه"
            ...
            // theme.primaryColor: "Sets a supplementary color that highlights key survey elements." => "یک رنگ تکمیلی تنظیم می کند که عناصر کلیدی فرم را برجسته می کند."
            // theme.panelBackgroundTransparency: "Adjusts the transparency of panels and question boxes relative to the survey background." => "شفافیت پانل ها و جعبه های سوال را نسبت به پیشینه فرم تنظیم می کند."
            // theme.questionBackgroundTransparency: "Adjusts the transparency of input elements relative to the survey background." => "شفافیت عناصر ورودی را نسبت به پیشینه فرم تنظیم می کند."
            ...
            // theme.--sjs-general-backcolor-dim: "Sets the main background color of the survey." => "رنگ پس زمینه اصلی فرم را تنظیم می کند."
            // header.inheritWidthFrom: "The \"Same as container\" option auto-adjusts the header content area width to fit into the HTML element the survey is placed in." => "گزینه \"همان کانتینر\" به طور خودکار عرض ناحیه محتوای هدر را تنظیم می کند تا در عنصر HTML که فرم در آن قرار می گیرد قرار گیرد."
            // header.textAreaWidth: "The width of the header area that contains the survey title and description, measured in pixels." => "عرض ناحیه سرصفحه که حاوی عنوان و توضیحات فرم است که بر حسب پیکسل اندازه گیری می شود."
            ...
            // progressBarInheritWidthFrom.survey: "Same as survey" => "همانند فرم"
            ...
            // pehelp.progressBarInheritWidthFrom: "The \"Same as container\" option auto-adjusts the progress bar area width to fit into the HTML element the survey is placed in." => "گزینه \"همان کانتینر\" به طور خودکار عرض ناحیه نوار پیشرفت را تنظیم می کند تا در عنصر HTML که فرم در آن قرار می گیرد قرار گیرد."
            ...
            // ed.propertyGridPlaceholderDescription: "Click any category icon to explore survey settings. Additional settings will become available once you add a survey element to the design surface." => "برای کاوش در تنظیمات فرم، روی هر نماد دسته کلیک کنید. پس از افزودن یک عنصر فرم به سطح طراحی، تنظیمات اضافی در دسترس خواهند بود."
            ...
            // ed.previewPlaceholderDescription: "The survey doesn't contain any visible elements." => "این فرم حاوی هیچ عنصر قابل مشاهده ای نیست."
            // ed.previewPlaceholderDescriptionMobile: "The survey doesn't contain any visible elements." => "این فرم حاوی هیچ عنصر قابل مشاهده ای نیست."
            ...
            // lg.logicPlaceholderDescription: "Create a rule to customize the flow of the survey." => "یک قانون برای سفارشی کردن جریان فرم ایجاد کنید."
            // lg.logicPlaceholderDescriptionMobile: "Create a rule to customize the flow of the survey." => "یک قانون برای سفارشی کردن جریان فرم ایجاد کنید."
            ...
            // header.overlapEnabled: "When enabled, the top of the survey overlays the bottom of the header." => "هنگامی که فعال باشد، بالای فرم پایین هدر را همپوشانی می کند."
            ...
            // names.sc2020: "Survey Creator 2020" => "خالق فرم 2020"
            ...
            // pehelp.autoAdvanceEnabled: "Select if you want the survey to auto-advance to the next page once a respondent has answered all questions on the current page. This feature won't apply if the last question on the page is open-ended or allows multiple answers." => "انتخاب کنید که آیا می خواهید فرم به طور خودکار به صفحه بعدی پیش برود پس از اینکه پاسخ دهنده به همه سؤالات موجود در صفحه فعلی پاسخ داد. اگر آخرین سؤال در صفحه باز باشد یا اجازه پاسخ های متعدد را بدهد، این ویژگی اعمال نمی شود."
            ...
            // survey.progressBarLocation: "Sets the location of the progress bar. The \"Auto\" value displays the progress bar above or below the survey header." => "مکان نوار پیشرفت را تنظیم می کند. مقدار \"خودکار\" نوار پیشرفت را در بالا یا پایین سربرگ فرم نشان می دهد."
            // survey.readOnly: "Make the survey read-only" => "فرم را فقط خواندنی کنید"
            // survey.readOnly: "Select if you want to prevent respondents from filling out your survey." => "اگر می خواهید از پر کردن فرم پاسخ دهندگان جلوگیری کنید، انتخاب کنید."
            ...
            // pehelp.defaultDisplayValue: "A value displayed in HTML questions and in the dynamic titles and descriptions of survey elements when the question value is empty." => "مقداری که در سؤالات HTML و در عناوین پویا و توضیحات عناصر فرم زمانی که مقدار سوال خالی است، نمایش داده می شود."
